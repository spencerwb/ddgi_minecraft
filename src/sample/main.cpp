...
int main(int argc, char** argv) {
    ...
    std::vector<Vertex> vertices = {
        ...
        // front face
        { { -0.5f, -0.5f,  0.5f, 1.f },{ 1.0f, 0.0f, 0.0f, 1.f } },
        { {  0.5f, -0.5f,  0.5f, 1.f },{ 1.0f, 0.0f, 0.0f, 1.f } },
        { {  0.5f,  0.5f,  0.5f, 1.f },{ 1.0f, 0.0f, 0.0f, 1.f } },
        { { -0.5f,  0.5f,  0.5f, 1.f },{ 1.0f, 0.0f, 0.0f, 1.f } },
        ...
        // top face
        { { -0.5f,  0.5f, -0.5f, 1.f },{ 0.0f, 1.0f, 0.0f, 1.f } },
        { { -0.5f,  0.5f,  0.5f, 1.f },{ 0.0f, 1.0f, 0.0f, 1.f } },
        { {  0.5f,  0.5f,  0.5f, 1.f },{ 0.0f, 1.0f, 0.0f, 1.f } },
        { {  0.5f,  0.5f, -0.5f, 1.f },{ 0.0f, 1.0f, 0.0f, 1.f } },
        ...
        // right face
        { {  0.5f, -0.5f, -0.5f, 1.f },{ 0.0f, 0.0f, 1.0f, 1.f } },
        { {  0.5f,  0.5f, -0.5f, 1.f },{ 0.0f, 0.0f, 1.0f, 1.f } },
        { {  0.5f,  0.5f,  0.5f, 1.f },{ 0.0f, 0.0f, 1.0f, 1.f } },
        { {  0.5f, -0.5f,  0.5f, 1.f },{ 0.0f, 0.0f, 1.0f, 1.f } },
    ...
    for (unsigned int i = 0; i < commandBuffers.size(); ++i) {
        ...
        vkCmdDrawIndexed(commandBuffers[i], indices.size(), 1, 0, 0, 1);
